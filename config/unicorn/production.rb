...
working_directory "/var/www/ttest01/current"    # 2
stderr_path "log/unicorn.stderr.log"    # 3
stdout_path "log/unicorn.stdout.log"    # 4
timeout 30    # 5
listen "/var/www/ttest01/current/tmp/sockets/unicorn.sock"    # 6
pid '/var/www/ttest01/current/tmp/pids/unicorn.pid'   # 7
preload_app true    # 8
